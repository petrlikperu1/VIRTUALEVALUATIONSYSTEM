  ...
  <div class="collapse navbar-collapse navbar-ex1-collapse">     
    <ul class="nav navbar-nav">      
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">        
           <li><a href="javascript:CallMant('<%=request.getContextPath()%>','Semestre',1,'')">Semestre</a></li>
                                <li><a href="javascript:CallMant('<%=request.getContextPath()%>','CarreraProfesional',1,'')">Carrera Profesional</a></li>
                                <li><a href="javascript:CallMant('<%=request.getContextPath()%>','Alumno',1,'')">Alumno</a></li>
                                <li><a href="javascript:CallMant('<%=request.getContextPath()%>','Docente',1,'')">Docente</a></li>
                                <li><a href="javascript:CallMant('<%=request.getContextPath()%>','Materia',1,'')">Materia</a></li>
                                <li><a href="javascript:CallMant('<%=request.getContextPath()%>','UnidadTematica',1,'')">Unidad Tematica</a></li>
                                <li><a href="javascript:CallMant('<%=request.getContextPath()%>','Tema',1,'')">Tema</a></li>
                                
                                
                                <li><a href="javascript:CallMant('<%=request.getContextPath()%>','TipoExamen',1,'')">Tipo Examen</a></li>
                                <li><a href="javascript:CallMant('<%=request.getContextPath()%>','Rol',1,'')">Rol</a></li>                                
                                <li><a href="javascript:CallMant('<%=request.getContextPath()%>','NivelDificultad',1,'')">Nivel Dificultad</a></li>                                   
        </ul>
      </li>
    ...
    <ul class="nav navbar-nav">   
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">                    
            <li><a href="javascript:CrearUsuario('<%=request.getContextPath()%>','CrearUsuario',0)"><img src="<%=request.getContextPath()%>/imagenes/gestionarusuarios.png"  width="35px" height="35px"   alt="Gestionar Usuario y Privilegios">Gestionar Usuario<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;y Privilegios</a></li>
