...
<html>
    <body onload="cargarFoco()">
                        ...
                        <div class="alert alert-info">
                            <h4><strong><center>Mantenimiento de la Tabla Carrera Profesional<br><br>Registrar Carrera Profesional</center></strong></h4>                            
                        </div> 
			...
			<div class="panel-body">                                              
				<div class="form-horizontal" role="form">    
					...
					<div class="form-group text-center">						
						<button type="submit" class="btn btn-primary" onclick="grabarCarreraProfesional('<%=codcad%>','<%=request.getContextPath()%>')" >
