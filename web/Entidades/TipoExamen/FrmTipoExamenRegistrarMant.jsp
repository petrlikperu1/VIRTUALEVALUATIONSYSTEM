    ...
    <body >
            ...
            <input type="hidden" name="hddcodigo" value="<%=codcad%>">
                        <div class="alert alert-info">
                            <h4><strong><center>Mantenimiento de la Tabla Tipo Examen<br><br>Registrar Tipo Examen</center></strong></h4>                            
                        </div>                         
			<div class="panel-body">                                              
				<div class="form-horizontal" role="form">    
					...
					<div class="form-group text-center">						
						<button type="submit" class="btn btn-primary"  onclick="grabarTipoExamen('<%=codcad%>','<%=request.getContextPath()%>')" 
