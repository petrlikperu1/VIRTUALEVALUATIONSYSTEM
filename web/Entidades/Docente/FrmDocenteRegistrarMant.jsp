...
<html>
    <body onload="cargarFoco()">
                        ...
                        <div class="alert alert-info">
                            <h4><strong><center>Mantenimiento de la Tabla Docente<br><br>Registrar Docente</center></strong></h4>                            
                        </div>                         
			<div class="panel-body">                                              
				<div class="form-horizontal" role="form">    
					...
					<div class="form-group">
						...
						<div class="col-lg-8">
							<input type="text" name="txtapelmate" id="txtapelmate"   placeholder="Ingrese Apellido Materno ..."  class="form-control"  required="required">
						</div>
					</div>
                                        <div class="form-group">
						<label for="Usuario" class="col-lg-3 control-label">Usuario :</label>
						<div class="col-lg-8">
							<input type="text" name="usuarioDoc" id="usuarioDoc"   placeholder="Ingrese  Usuario ..."  class="form-control"  required="required">
						</div>
					</div>        
                                        <div class="form-group">
						<label for="Clave" class="col-lg-3 control-label">Clave :</label>
						<div class="col-lg-8">
							<input type="text" name="claveDoc" id="claveDoc"   placeholder="Ingrese  Clave ..."  class="form-control"  required="required">
						</div>
					</div>     
					...
					<div class="form-group text-center">						
                                            <button type="submit" class="btn btn-primary" onclick="grabarDocente('<%=codcad%>','<%=request.getContextPath()%>')" >
							<img src="<%=request.getContextPath()%>/imagenes/grabar.png"   width="20px" height="20px"  alt="Grabar"> Grabar
						</button>
                                                <button type="submit" class="btn btn-primary" onclick="salir('<%=request.getContextPath()%>','Docente',5,'')" >
