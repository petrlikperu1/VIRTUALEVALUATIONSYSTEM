...
<html>
    <body >
                        ...
                        <div class="alert alert-info">
                            <h4><strong><center>Mantenimiento de la Tabla Nivel de Dificultad<br><br>Registrar Nivel de  Dificultad</center></strong></h4>                            
                        </div>                         
			<div class="panel-body">                                              
				<div class="form-horizontal" role="form">    
					...
					<div class="form-group text-center">						
						<button type="submit" class="btn btn-primary" onclick="grabarNivelDificultad('<%=codcad%>','<%=request.getContextPath()%>')" >
