...
function   RendirExamenSupervisado1(ruta, tabla, op, parametros, tiempo, activartimer)
{ 
              var pagina=ruta+"/"+tabla+"Servlet?"+parametros;  
              document.form.action=pagina;
              document.form.method="POST";
...
function   RendirExamen1(ruta, tabla, op, parametros, tiempo, activartimer)
{ 
              var pagina=ruta+"/"+tabla+"Servlet?"+parametros;  
              document.form.action=pagina;
              document.form.method="POST";
...
function   RendirExamen2(ruta, tabla, op, parametros, tiempo, activartimer)
{ 
    linML = 0;
