        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div >
						...
						<label for="codigo" class="col-lg-3 control-label">Escribir Contraseña Actual :</label>
						<div class="col-lg-8">
							<input type="password" name="txtclave1"  id="txtclave1" placeholder="Ingrese Clave Actual" onkeyup="validarClaveActual('<%=request.getContextPath()%>','Alumno',19,'<%=parametros%>')" class="form-control" >
						<div id="correcto" ></div>
                                                </div>
					</div>
					
                                            <div class="form-group">
						<label for="codigo" class="col-lg-3 control-label">Escribir Nueva Contraseña :  </label>
						<div class="col-lg-8">
                                                    <input type="password" name="txtclavenueva"  id="txtclavenueva" placeholder="Ingrese Nueva Clave " disabled=false  class="form-control"  onkeyup="validarClaveNueva('<%=request.getContextPath()%>','Alumno',22)" >
						<div id="correcto0" ></div>
						</div>
					</div>      
                                              
                                           <div class="form-group">
						<label for="codigo" class="col-lg-3 control-label">Repetir Nueva Contraseña:</label>
						<div class="col-lg-8">
                                        
						<input type="password" name="txtrepetirclave" id="txtrepetirclave" placeholder="Repita el Ingreso Nueva Clave"  disabled=false  onkeyup="validarRepetirClaveNueva('<%=request.getContextPath()%>','Alumno',20)" class="form-control" >
						...
						<input type="button"  onclick="GrabarCambiosClave('<%=request.getContextPath()%>','Alumno',21,'<%=parametros%>')" value="Grabar Cambios" style="height:28px;
                                                                                                        width:120px;" />
                                                <input type="button" onclick="inicio()"   value="Salir" style="height:28px;
                                                                                                        width:80px;" />
					</div>
					<hr>
